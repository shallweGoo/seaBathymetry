...
fileInfo.file_dir.dir_name = "..\selectPic\afterPer\双月湾第二组变换后\变换后图片"+dir_ind+"相关处理\";
...
fileInfo.org_imag.file_path = "..\selectPic\afterPer\双月湾第二组变换后\变换后图片"+dir_ind+"\";
...
fileInfo.bp_filter.used_filter = load("..\filter_mat\bpfilter0.05_0.5Fs2.mat"); %注意修改对应的滤波器
